...
if(isset($_POST['inloggen'])){
    if(empty($_POST['wachtwoord']) && empty($_POST['naam']))
    {
        ...
        $stmt = $con->prepare('SELECT * FROM admininlog WHERE naam = :naam AND wachtwoord = :wachtwoord');
...
<form class="form_main" action="" method="post">
    ...
    <input placeholder="Username" id="username" class="inputField" type="text" name="naam">
    </div>
...
<div class="inputContainer">
    ...
    <input placeholder="Password" id="password" class="inputField" type="password" name="wachtwoord">
</div>
                        
<button id="button" name="inloggen">Submit</button>
